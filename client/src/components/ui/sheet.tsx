  ...
  'fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-neutral-950',
  {
    variants: {
      side: {
        ...
        bottom:
          'inset-x-0 bottom-0 border-t border-neutral-200 dark:border-neutral-800 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom',
        left: 'inset-y-0 left-0 h-full w-3/4 border-r border-neutral-200 dark:border-neutral-800 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:max-w-xl',
        right:
          'inset-y-0 right-0 h-full w-full border-l border-neutral-200 dark:border-neutral-800 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right sm:max-w-2xl',
      },
    },
    defaultVariants: {
      side: 'right',
